...
export class ProducaoRecebidaService {

  private apiServer : string = environment.apiServer
  private apiUri : string = this.apiServer + 'producao_recebida'
  ...
  excluir(id: string) {
      ...
      // o back-end
      //return this.http.delete(this.apiServer + 'producao_recebida/' + id).toPromise()
