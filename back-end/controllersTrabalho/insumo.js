...
const Insumo = require('../modelsTrabalho/Insumo')
...
controller.listar = async (req, res) => {
    try {
        let dados = await Insumo.find()// Traz todos os cursos cadastrados
...
controller.obterUm = async (req, res) => {
    try {
        ...
        let obj = await Insumo.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let ret = await Insumo.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let ret = await Insumo.findByIdAndDelete(id)
